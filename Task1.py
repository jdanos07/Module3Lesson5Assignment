...
# Objective: The goal of this assignment is to deepen your understanding of the 
# OS module in Python.

# Task 1: Directory Inspector:

# Problem Statement: Create a Python script that lists all files and 
# subdirectories in a given directory. Your script should prompt the 
...
# in the specified directory. Handle exceptions for invalid paths or inaccessible 
# directories.

import os

def list_directory_contents():
    directory = input('Input directory to view it\'s contents: ')
    # directory = ('.')
